...
import { ingestWhatsappTicket, ingestEmailTicket, uploadManualTicket, uploadManualPdfTickets, processTicketOcr, getTickets, getTicketStats, getTicketById, updateTicket, linkTicketToOrder, unlinkTicketFromOrder, deleteTicket, getOcrJobStatus, processPendingOcrJobsEndpoint, } from './ticket.controller.js';
const router = Router();
const upload = multer({
