...
export const DispatchService = {
    ...
    async assignDriver(orderId, driverId, priority = 1) {
    ...
    async reorderDeliveries(driverId, deliveryIds) {
    ...
    async resendAssignmentEmail(deliveryId) {
