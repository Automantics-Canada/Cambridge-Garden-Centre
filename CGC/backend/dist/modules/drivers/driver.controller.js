...
export const getLoggedInDriverProfile = async (req, res) => {
    try {
        if (!req.user) {
...
const fallbackNodemailer = async (email, name, password, html) => {
...
export const updateDriver = async (req, res) => {
    try {
        ...
        if (data.ratePerDelivery !== undefined)
            data.ratePerDelivery = Number(data.ratePerDelivery);
        if (data.ratePerTrip !== undefined)
            data.ratePerTrip = Number(data.ratePerTrip);
