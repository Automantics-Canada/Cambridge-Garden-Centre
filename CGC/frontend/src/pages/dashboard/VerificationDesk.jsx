    ...
    <div className="flex flex-col h-full bg-canvas -m-8 p-8 overflow-y-auto">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="relative w-full sm:w-72">
            ...
            <input 
              ...
              className="w-full pl-10 pr-4 py-2.5 bg-ink/[0.03] border border-line rounded-xl text-sm focus:ring-2 focus:ring-brand outline-none transition-all placeholder:text-muted font-light"
              value={search}
          ...
          {/* Status Filter Tabs */}
          <div className="flex items-center gap-1 bg-ink/[0.06] p-1 rounded-xl w-full sm:w-auto overflow-x-auto">
            ...
            return (
              <div 
                ...
                className={`bg-surface rounded-card border transition-all duration-300 overflow-hidden ${
                  isExpanded 
                    ? 'border-brand shadow-xl shadow-card ring-1 ring-brand' 
                    : 'border-line hover:border-brand/30 hover:shadow-md hover:shadow-lift shadow-sm'
                }`}
              >
                      ...
                      <div className="p-6 md:p-8 space-y-6">
                        ...
                        <div className="bg-surface rounded-3xl p-6 border border-line shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-6">
                          ...
                          <div className="flex items-center gap-3">
                            {selectedInvoice.status === 'PENDING_REVIEW' && (
                              <>
                                <button 
                                  ...
                                  className={`px-6 py-2.5 rounded-xl font-medium text-xs transition-all border ${showDisputeInput ? 'bg-clay text-on-clay border-clay shadow-sm' : 'bg-surface text-clay border-clay/30 hover:bg-clay/10'}`}
                                >
                                ...
                                <button 
                                  ...
                                  className="px-8 py-2.5 bg-brand hover:bg-black text-on-brand font-medium text-xs rounded-xl transition-all shadow-lg shadow-card flex items-center gap-2 disabled:opacity-50"
                                >
                            ...
                            {/* {selectedInvoice.status !== 'PENDING_REVIEW' && (
                              ...
                              //   className="px-6 py-2.5 bg-ink text-on-brand rounded-xl font-medium text-xs hover:bg-black transition-all shadow-sm"
                              // >
                              //   Reopen Record
                              // </button>
                            )} */}
                        ...
                        <AnimatePresence>
                          {showDisputeInput && (
                            <motion.div 
                              ...
                              animate={{ height: 'auto', opacity: 1 }}
                              exit={{ height: 0, opacity: 0 }}
                              className="bg-clay rounded-3xl p-6 flex flex-col md:flex-row md:items-center gap-6 overflow-hidden shadow-inner"
                            >
                              ...
                              <div className="flex-1">
                                ...
                                <input 
                                  ...
                                  className="w-full bg-clay/50 border-clay/40 rounded-xl px-4 py-2.5 mt-1.5 text-on-brand placeholder:text-on-clay/70 outline-none focus:ring-2 focus:ring-white transition-all border text-sm"
                                  value={disputeNote}
                              ...
                              <button 
                                ...
                                disabled={isProcessing}
                                className="px-8 py-3 bg-surface text-clay font-semibold text-xs rounded-xl hover:shadow-xl transition-all disabled:opacity-50 flex-shrink-0 self-end md:self-auto"
                              >
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                                ...
                                {isDocPreviewExpanded && (
                                  ...
                                  >
                                    <div className="p-4 bg-ink/[0.03]">
                                      <div 
                                        className="aspect-[3/4] rounded-2xl overflow-hidden relative group cursor-pointer border border-line/80 bg-surface" 
                                      ...
                                      >
                                        ...
                                        <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent flex flex-col justify-end p-6">
                                          <div className="flex items-center justify-between">
                                            <span className="text-on-brand text-[12.5px] font-semibold uppercase tracking-widest opacity-80">Zoom scan</span>
                            ...
                            <div className="bg-brand rounded-3xl p-6 text-on-brand shadow-lg shadow-card">
                              ...
                              <div className="space-y-4">
                                ...
                                <div className="flex items-center justify-between border-t border-brand/40 pt-4">
                                  ...
                                  <span className="text-xs font-semibold bg-surface/10 px-3 py-1 rounded-full uppercase tracking-wider">{selectedInvoice.status}</span>
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="lg:col-span-7 space-y-4">
                            <h3 className="text-xs font-semibold text-muted uppercase tracking-widest mb-1 pl-1">Line Item Reconciliations</h3>
                            ...
                            {selectedInvoice.lineItems?.map((li, idx) => {
                              ...
                              return (
                                <div 
                                  key={li.id} 
                                  className={`bg-surface rounded-3xl border transition-all ${
                                    isLineExpanded 
                                      ? 'border-brand/40 shadow-sm' 
                                      : 'border-line hover:border-line shadow-sm hover:shadow'
                                  }`}
                                >
                                    ...
                                    <div className="flex items-start gap-4">
                                      ...
                                      <div>
                                        ...
                                        <div className="flex items-center gap-3 mt-1.5">
                                          <span className="text-xs font-medium text-muted">QTY: {Number(li.quantity).toFixed(0)} {li.unit}</span>
                                          <div className="w-1.5 h-1.5 bg-ink/[0.08] rounded-full" />
                                          <span className="text-xs font-semibold text-brand bg-brand/10 px-2 py-0.5 rounded-full uppercase tracking-wide">PO: {li.poNumber || 'N/A'}</span>
                                        </div>
                                      </div>
                                    </div>
                                    ...
                                    {isLineExpanded && (
                                      ...
                                      >
                                        <div className="p-6 space-y-6">
                                          ...
                                          {li.approvedTotal && (
                                            <div className="bg-ink/[0.03] rounded-2xl p-4 border border-line flex flex-col sm:flex-row justify-between gap-3 text-xs">
                                              <div className="space-y-1">
                                                <p className="text-muted font-light uppercase tracking-wider">Calculation Details</p>
                                                ...
                                                {li.matchedTickets?.length > 0 ? (
                                                  <div className="space-y-2">
                                                    {li.matchedTickets.map(t => (
                                                      <div key={t.id} className="bg-ink/[0.03] p-2.5 rounded-xl flex items-center gap-3 border border-line group">
                                                        <div 
                                                          className="w-10 h-10 rounded-lg overflow-hidden border border-line cursor-pointer flex-shrink-0 bg-surface" 
                                                        ...
                                                        <div className="flex-1 min-w-0">
                                                          ...
                                                          <p className="text-[12.5px] font-bold text-brand uppercase mt-0.5">{Number(t.quantity)} {t.unit}</p>
                                                        </div>
                                                        <button 
                                                          onClick={() => handleUnlinkTicket(li.id, t.id)}
                                                          disabled={isProcessing}
                                                          className="opacity-0 group-hover:opacity-100 p-1 hover:bg-clay/10 text-clay rounded-lg transition-all flex-shrink-0"
                                                          title="Unlink Ticket"
                                                        >
                                                          <X className="w-3 h-3" />
                                                        </button>
                                                  ...
                                                  <div className="py-6 text-center bg-ink/[0.03] rounded-2xl border-2 border-dashed border-line">
                                              ...
                                              <div className="flex-1">
                                                {li.matchedOrderId ? (
                                                  <div className="space-y-3">
                                                    <div className="bg-brand rounded-xl p-4 text-on-brand relative overflow-hidden group shadow-sm">
                                                      ...
                                                      <button 
                                                        ...
                                                        disabled={isProcessing}
                                                        className="absolute top-2.5 right-2.5 opacity-0 group-hover:opacity-100 p-1 bg-surface/10 hover:bg-surface/20 rounded-lg transition-all"
                                                        title="Unlink Order"
                                                      >
                                                    ...
                                                    {li.matchedOrder?.deliveries?.map(del => (
                                                      <div key={del.id} className="bg-ink/[0.03] rounded-xl p-3 border border-line space-y-2">
                                                        ...
                                                        <div className="grid grid-cols-2 gap-2">
                                                          <div className="border border-line rounded-lg overflow-hidden group/img relative bg-surface aspect-video flex flex-col justify-end">
                                                            {del.pickupPhotoUrl ? (
                                                            ...
                                                            <div className="bg-black/40 p-1 relative z-10"><p className="text-[12px] text-on-brand font-bold uppercase tracking-widest text-center">Pickup</p></div>
                                                          </div>
                                                          <div className="border border-line rounded-lg overflow-hidden group/img relative bg-surface aspect-video flex flex-col justify-end">
                                                            ...
                                                            <div className="bg-black/40 p-1 relative z-10"><p className="text-[12px] text-on-brand font-bold uppercase tracking-widest text-center">Delivery</p></div>
                                                          </div>
                                                        </div>
                                                      </div>
                                                    ))}
      ...
      {linkingLineItem && (
        <div className="fixed inset-0 bg-black/75 z-[100] flex items-center justify-center p-6 backdrop-blur-sm">
          <div className="bg-surface w-full max-w-xl rounded-card overflow-hidden shadow-2xl animate-in zoom-in-95 duration-200">
            <div className="p-8 border-b border-line flex items-center justify-between bg-ink/[0.03]">
              <div>
                ...
                <p className="text-xs font-semibold text-brand uppercase mt-1.5 tracking-wider">Lookup {linkingLineItem.type} in central database</p>
              </div>
              <button onClick={() => setLinkingLineItem(null)} className="p-3 hover:bg-ink/[0.06] rounded-2xl transition-all">
            ...
            <div className="p-8 space-y-6">
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full pl-12 pr-4 py-4 bg-ink/[0.03] border border-line rounded-2xl text-base font-light focus:ring-4 focus:ring-brand/20 outline-none transition-all placeholder:text-muted"
              ...
              <div className="max-h-80 overflow-y-auto space-y-2 pr-2 custom-scrollbar">
                {searching ? (
                  ...
                  searchResults.map(res => (
                    ...
                    >
                      <div className="flex items-center gap-4">
                        <div className="w-12 h-12 bg-surface rounded-xl shadow-sm border border-line flex items-center justify-center">
        ...
        <div className="fixed inset-0 bg-black/95 z-[200] flex flex-col pt-12 pb-6 px-4 sm:px-12 animate-in fade-in duration-300" onClick={() => setZoomedImage(null)}>
          ...
          <div className="h-16 sm:h-20 flex-shrink-0 flex items-center justify-center gap-8 mt-4">
            <a 
              ...
              rel="noreferrer"
              onClick={e => e.stopPropagation()}
              className="flex items-center gap-2 text-on-brand/60 hover:text-on-brand font-medium text-xs uppercase tracking-wider transition-colors bg-surface/5 hover:bg-surface/10 px-4 py-2 rounded-lg"
            >
...
function VerificationDeskSkeleton() {
  return (
    <div className="flex flex-col h-full bg-canvas -m-8 p-8 overflow-y-auto">
      ...
      <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-4 mb-8 bg-surface p-6 rounded-card border border-line shadow-sm animate-pulse">
        <div className="space-y-2">
      ...
      <div className="space-y-4 animate-pulse">
        {[...Array(4)].map((_, i) => (
          <div key={i} className="bg-surface rounded-card border border-line p-6 md:p-8 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div className="flex items-center gap-4 flex-1">
